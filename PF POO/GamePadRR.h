...
//void GamePadEstado(HWND hWnd, XINPUT_STATE& stata)
//{
//	DWORD dwResult;
//
//
...
//	{
//		//MessageBox(hWnd, L"Controlador conectado", L"Funciono", 0);
//	}
//	else
//	{
//		//MessageBox(hWnd, L"Controlador no conectado", L"No Funciono", 0);
//	}
//
//}
...
//}
//
//if (!(XINPUT_GAMEPAD_B & state.Gamepad.wButtons) && !(XINPUT_GAMEPAD_X & state.Gamepad.wButtons))
//{
//	ryuest = true;
//	ryumov = false;
//}